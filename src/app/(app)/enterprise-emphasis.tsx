...
export const EnterpriseEmphasis = ({
  ...
  <section className="py-16 space-y-12">
    ...
    <div className="mx-auto max-w-7xl px-8 flex min-h-min max-lg:flex-col p-4 relative">
      <span
        aria-hidden
      ...
      <div className="w-full h-full max-xl:relative">
        {!!enterpriseEmphasis.banner_emphasis.url && (
          <Image
            ...
            height={1080}
            priority
            className="w-full lg:h-[620px] h-[300px] object-cover object-center"
          />
        )}
        <span
          aria-hidden
      ...
      <div className="space-y-10 w-full p-8 py-10 xl:max-w-sm max-lg:mt-8 bg-blue !text-white [&_p]:!text-white flex flex-col">
